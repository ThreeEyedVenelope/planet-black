...
///         b. The "Name" text object that's a child of the dialogue gameObject
///         c. The "DialogueText" text object that's a child of the dialogue gameObject
/// </summary>
public class DialogueManager : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("This is the text object child of the dialogue bar that's meant to display the name in the dialogue box.")]
    ...
    public void StartDialogue(Dialogue dialogue)
    {
        ...
        // Set the name of the person talking
